...
# Data Analysis:
* Intraday Stock Market Corrections: This analysis takes into consideration intraday corrections larger than 2.71% during the three most recent presidencies. Using Poisson's distribution, it calculate the likelihood of corrections under each presidency.
  
# Linear Regression:
* Multiple Linear Regression (MLR): Predicting Property Values in Cook County, IL.
  * Part 1: Exploratory Data Analysis
  * Part 2: Models - feature fitting, tuning, scoring, etc.

# Neurosymbolic_AI System for Loan Underwriting
